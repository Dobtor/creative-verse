odoo.define('dobtor_team.profile_info_edit', function (require) {
    'use strict';
    ...
    publicWidget.registry.teamProfileInfoEdit = publicWidget.Widget.extend({
        selector: '#team_info_block',
        events: {
            'click .o_wteam_info_js_edit': '_onEditClick',
            'click .o_wteam_edit_submit_btn': '_SaveClick', 
            'click .o_wteam_edit_js_cancel': '_CancelClick',
        ...
        start: function () {
            this.team_id = this.$el.data('team_id');
        ...
        _onEditClick: function (ev) {
            ...
            ev.preventDefault();
            return this._rpc({
                route: '/team/template/display',
                params: { team_id: this.team_id, info_edit: true},
    ...
    return {
        teamProfileInfoEdit: publicWidget.registry.teamProfileInfoEdit,
    };
